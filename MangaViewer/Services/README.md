...
- `GoogleGenAIChatClient`, `OpenAIChatClient`, `AnthropicChatClient`, `OllamaChatClient`: provider adapters exposed as `Microsoft.Extensions.AI` clients. `GoogleGenAIChatClient` and `AnthropicChatClient` call their provider REST APIs directly.
